...
def write_labels(main_directory_path, dataset_name, label_file_name='labels.txt'):
    ...
    with open(external_working_directory_path + 'user/datasets/' + dataset_name + '/' + label_file_name, 'a') as labels:
    ...
    with open(external_working_directory_path + 'user/datasets/' + dataset_name + '/obj_labels.json', 'w') as txt:
